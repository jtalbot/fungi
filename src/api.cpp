...
int fungiIdentity(lua_State* L) {
    ...
    if(argc != 0)
        std::cerr << "fungiIdentity takes 0 arguments" << std::endl;
...
int fungiTranslate(lua_State* L) {
    int argc = lua_gettop(L);
    if(argc != 3)
        std::cerr << "fungiTranslate takes 3 arguments" << std::endl;
...
int fungiScale(lua_State* L) {
    int argc = lua_gettop(L);
    if(argc != 3)
        std::cerr << "fungiScale takes 3 arguments" << std::endl;
...
int fungiRotate(lua_State* L) {
    int argc = lua_gettop(L);
    if(argc != 4)
        std::cerr << "fungiRotate takes 4 arguments" << std::endl;
...
int fungiLookAt(lua_State* L) {
    int argc = lua_gettop(L);
    if(argc != 9)
        std::cerr << "fungiLookAt takes 9 arguments" << std::endl;
...
int fungiMultiply(lua_State* L) {
    int argc = lua_gettop(L);
    if(argc != 2)
        std::cerr << "fungiMultiply takes 2 arguments" << std::endl;
